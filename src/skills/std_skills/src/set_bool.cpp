...
: BT::RosServiceNode<SetBoolServiceType>{name, config, params}, service_name_{name}
{
  return;
}

bool SetBool::setRequest(RequestPtr & req)
{
  bool data;
...
BT::NodeStatus SetBool::onResponseReceived(const ResponsePtr & response)
{
  if (!response->success) {
