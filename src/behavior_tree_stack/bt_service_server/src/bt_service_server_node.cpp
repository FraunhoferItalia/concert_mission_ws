...
int main(int argc, char ** argv)
{
  ...
  // uncomment to run default tree on launchup
  //if (!bt_manager->bt_executor->runDefaultTree())
  //{
  //  rclcpp::shutdown();
  //}

  bt_service_server::BTServiceServer bt_service_server(bt_manager->bt_executor, bt_executor_node_);
